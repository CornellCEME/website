...
<head>
	<title>Cornell Eastern Music Ensemble</title>
     <link rel="stylesheet" type="text/css" href="styles/main2.css" media="only screen and (min-width: 400px)"/>
	<link rel="stylesheet" type="text/css" href="styles/mobile.css" media="only screen and (max-width: 401px)"/>
     <link rel="stylesheet" type="text/css" href="styles/apply.css" media="only screen and (min-width: 300px)"/>
